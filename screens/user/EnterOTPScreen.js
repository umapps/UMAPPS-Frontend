...
const EnterOTPScreen = (props) => {
    ...
    const registerHandler = async () => {
        if (
            (emailOTP.trim().length != 4 && email.trim().length > 1) ||
            mobileOTP.trim().length != 4
        ) {
        ...
        if (Constants.isDevice) {
            ...
            if (finalStatus !== 'granted') {
                alert(
                    'App not permitted for push notifications. Please provide this permission if you wish to receive push notifications'
                )
            } else {
        ...
        try {
            ...
            Alert.alert(
                ...
                'User ' +
                    ...
                    ' ' +
                    lName +
                    ' added successfully. Please login to continue'
            )
                ...
                <View style={styles.authContainer}>
                    <ScrollView>
                        ...
                        <Card style={styles.authContainer}>
                            <View>
                                <Text>
                                    Enter OTP received to your Email address{' '}
                                    {email}
                                </Text>
                            </View>
                            <InputCode
