...
const ForgotPasswordScreen = (props) => {
    ...
    const forgotPasswordHandler = async () => {
        ...
        if (!updatedStatus) {
            ...
            formState.inputValidities.mobile = inputChangeHandler(
                'mobile',
                formState.inputValues.mobile
            )
            return
        ...
        let action
        action = authActions.sendForgotPwOtp(formState.inputValues.mobile)
        setError(null)
        setIsLoading(true)
        try {
    ...
    const isValidCheck = (inputIdentifier, inputValue) => {
        ...
        switch (inputIdentifier) {
            ...
            case 'mobile':
                ...
                (mobileNbrRegex.test(inputValue) || emailRegex.test(inputValue))
                    ? (isValidText = true)
                    : (isValidText = false)
                break
            default:
            ...
            <View style={styles.authContainer}>
                <View style={styles.textContainer}>
                    <Text style={styles.textContainer}>
                        Provide your Mobile Number or Email Id{' '}
                    </Text>
                    <Text style={{ marginBottom: 25 }}>
                        Same OTP will be sent to both Mobile number and Email Id
                        (if registered)
                    </Text>
                </View>
                <View>
                    ...
                    {createErrorText(
                        'MOBILE',
                        'Invalid Mobile Number/ Email Id'
                    )}
