...
class UMNotificationsScreen extends Component {
    ...
    render() {
        ...
        if (isLoading) {
        ...
        else if (notificationList === undefined || notificationList.length === 0) {
            return (<View
                style={{
                    flex: 1,
                    width: '100%',
            ...
            const notificationsCardList = notificationList.map(notifcation =>
                ...
                <Card>
                    ...
                    <CardItem footer>
                        <Text>{moment(notifcation.createdDate).format('DD/MM/YYYY')}</Text>
                    </CardItem>
                </Card>
            );
            return (
